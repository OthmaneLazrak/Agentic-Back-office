...
import ChequePage from "./pages/ChequePage.jsx";
        ...
        <div className="main">
          ...
          <div className="content">
            ...
            {activePage === "historique" && (
              <ProtectedRoute roles={[ROLES.FRONT_OFFICE, ROLES.BACK_OFFICE]}>
                <HistoryPage userRole={userRole} userId={selectedUser.id} />
              </ProtectedRoute>
            )}
            {activePage === "admin" && (
